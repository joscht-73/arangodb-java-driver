...
public class DocumentTest extends BaseTest {
	...
	public void insertAsJson() {
		...
		final Object article = doc.get("article");
	...
	public void insertAsBaseDocument() {
		final BaseDocument document = new BaseDocument();
		{
			...
			document.put("article", article);
			article.put("artist", "PREGARDIEN/RHEINISCHE KANTOREI/DAS");
			article.put("releaseDate", "1970-01-01");
			article.put("composer", "BACH");
			article.put("format", "CD");
			article.put("vat", "H");
			article.put("carriers", 1);
			article.put("label", "CAPRICCIO");
			article.put("title", "BACH ST MATTHEW PASSION BWV244");
			article.put("barcode", new String[] { "4006408600466" });
			article.put("conductor", "MAX, H.");
			final BaseDocument stock = new BaseDocument();
			document.put("stock", stock);
			stock.put("status", "RMV");
			stock.put("lastUpdate", "2016-11-01 00:00");
		}
